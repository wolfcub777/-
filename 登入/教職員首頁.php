...
// 檢查是否已登入
if (!isset($_SESSION['account']) || !isset($_SESSION['identity']) || ($_SESSION['identity'] !== '教師' && $_SESSION['identity'] !== '職員')) {
...
$sql = "SELECT * FROM `新版使用者` WHERE 學號 = ? AND (身分 = '教師' OR 身分 = '職員')";
...
<body>
    <div class="container">
        ...
        <p>職員編號：<?php echo $user['學號']; ?></p>
        <p>科別 / 處室：<?php echo $user['科別']; ?></p>
